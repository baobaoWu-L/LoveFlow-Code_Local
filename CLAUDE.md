...
This is a **LoveFlowCode** fork of the open-source Claude Code CLI tool, rebranded with pink theme and LoveFlowCode identity. TypeScript strict mode is enforced — **`bun run precheck` 必须零错误通过**（包含 typecheck + lint fix + test）。
